...
// Load the pre-built trie (generated by scripts/build-trie.ts).
const classifyTrie: TrieNode = JSON.parse(
  readFileSync(resolve(DATA_DIR, "classifier-trie.json"), "utf-8"),
);
